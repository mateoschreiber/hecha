...
export default async function Expedients({searchParams}:{searchParams:Promise<Params>}) {
  ...
  const [listing, freshness]=await Promise.all([getApi<Listing>(path), getApi<{data:Freshness}>("/meta/freshness")]);
